...
<div class="container">
    <div class="user-info">
        ...
        <div class="detail">
            ...
            <p>邮箱：${user.email}</p>
            <p>注册时间：2019.1.1</p>
            <button type="button" class="btn btn-default btn-sm pull-right" data-toggle="modal" data-target="#delete-account">注销账号</button>
        ...
        <div class="modal-dialog modal-sm" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <a href="/user/delete"><button type="button" class="btn btn-danger conform-delete">确定</button></a>
